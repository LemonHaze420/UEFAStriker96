...
{
	0,0,0,45000,250,			// republica
	0,1,0,699*150,250,		// jarre
	0,2,0,752*150,250,		// maddona
	0,3,0,40000,250,			// odwod	
	0,4,0,999999,250,		
	0,5,0,999999,250,				
	0,6,0,999999,250,				
	0,7,0,999999,250,				
...
//	FntPrint("check audio track\n");
	...
	bob_audio_pos = audio_track_pos - audio_track_start;
