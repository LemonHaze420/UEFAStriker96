...
#define TEXTURE_AREA_SIZE 560000
...
/** Allocate memory to unpack file into **/
	pak_file = read_datafile_alloc ( filenum );	// load the .TEX file
	texture_temp = allocate_mem( 0,TEXTURE_AREA_SIZE );

/** Load packed file **/

/** Unpack it to allocated mem **/
	unpropak( pak_file , texture_temp );
