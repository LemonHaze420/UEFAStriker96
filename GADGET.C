...
/**** Info box *****/
	...
	ts = add_text_string ( tslot_poses[REQUEST_TSLOT]+0, request_text , MILFORD_FONT, milford_font_logic, 0, info_box_y, FONT_XC+FONT_YC, -2, 0, 10,0,0 );
